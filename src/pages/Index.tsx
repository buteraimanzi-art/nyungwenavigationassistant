        ...
        <>
          ...
          <div className="hidden md:flex flex-1 overflow-hidden">
            ...
            <main className="flex-1 relative">
              <TrailMap trail={selectedTrail} userLocation={userLocation} onSelectAttraction={setSelectedAttraction} onSelectRestArea={setSelectedRestArea} />
          ...
          <div className="md:hidden flex-1 flex flex-col relative">
            ...
            <div className={`absolute left-0 right-0 bottom-0 bg-card border-t border-border rounded-t-2xl shadow-lg transition-all duration-300 ${isBottomSheetExpanded ? 'h-[70vh]' : 'h-[180px]'}`}>
